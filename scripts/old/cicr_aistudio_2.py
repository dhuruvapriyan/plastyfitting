...
def _apply_primed_junctional_debug(cai_1syn, t, cp, cq, is_apical, dp):
    ...
    gamma_p = float(dp.get("gamma_p", 20.0))
...
class PrimedJunctionalCICRModel(CICRModel):
    DESCRIPTION = "Primed-Junctional V4.2 (Linear Slow Water Bucket)"
    ...
    FIT_PARAMS = [
        ...
        ("a30", 0.1, 5.0),
        ("a31", 0.1, 5.0),
        ("k_fill", 0.0001, 0.5),       # CRITICAL: Max filling rate bounded to be incredibly slow
    ...
    DEFAULT_PARAMS = {
        "gamma_d": 150.0, "gamma_p": 20.0,
        "a00": 1.0, "a01": 1.0, "a10": 1.5, "a11": 2.0,
        "a20": 1.0, "a21": 1.0, "a30": 1.5, "a31": 2.0,
        "k_fill": 0.05, "tau_leak": 120000.0, 
        "K_clip": 0.0005, "K_trig": 0.0025, "n_trig": 6.0,
        "Vmax_CICR": 0.1, "tau_CICR": 250.0,
        "g_cicr": 10000.0, "tau_eff": 200.0,
    }
